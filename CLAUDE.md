...
1. **工具问题** → 查看工具的 GitHub Issues
2. **权限问题** → 使用 enumerate-iam / get-iam-policy
3. **云平台特定** → 查看云平台官方文档
4. **攻击思路** → 参考 HackTricks 云安全部分
5. **国内云厂商** → 参考对应平台的 API 文档
...
- **2025-03-18**: 初始版本
  - 整合 AWS Penetration Testing 技能
  - 整合 Cloud Penetration Testing 技能
  - 添加国内云厂商支持
  - 创建能力映射表
